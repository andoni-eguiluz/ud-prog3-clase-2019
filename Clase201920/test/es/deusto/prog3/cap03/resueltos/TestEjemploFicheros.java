...
public class TestEjemploFicheros {
	...
	public void setUp() throws Exception {
		...
		// Fallo para el test de comas: meter una coma en un campo
		...
		// Fallo para el test de tags: 
		// miListaUsuarios.add( new Usuario( "buzz2", "#9a\nbbf", "Buzz", "Lightyear", 101202303, TipoUsuario.Admin, "buzz@gmail.com", "amigo.de.woody@gmail.com" ) );
		// Fallo para el test de bd:
		// miListaUsuarios.add( new Usuario( "buzz2", "#9'abbf", "Buzz", "Lightyear", 101202303, TipoUsuario.Admin, "buzz@gmail.com", "amigo.de.woody@gmail.com" ) );
	}
