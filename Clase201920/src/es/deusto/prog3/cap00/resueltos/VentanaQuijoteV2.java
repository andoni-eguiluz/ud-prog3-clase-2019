...
//Probar que si quitamos el sleep la CPU se pone al máximo
 ...
 */
public class VentanaQuijoteV2 extends JFrame {

	private JTextArea taTexto;
	private JScrollPane spTexto;
	
	public VentanaQuijoteV2() {
	...
	private void cargaQuijote() {
		try {
			Scanner scanner = new Scanner( VentanaQuijoteV2.class.getResourceAsStream( "DonQuijote.txt" ), "UTF-8" );
	...
	public static void main(String[] args) {
		VentanaQuijoteV2 v = new VentanaQuijoteV2();
		v.setVisible( true );
		v.cargaQuijote();
	}
